...
class RecipesDetail extends Component{
	constructor(props) {
	  ...
	  this.state = {
			detals:[{
				...
				nandu:'切墩(初级)',
				times:'1小时以上',
				zhuliao:[{name:'',nums:''},{name:'后臀肥瘦猪肉',nums:'750克'},{name:'面粉',nums:'500克'},{name:'水',nums:'260克'},{name:'酵母',nums:'3克'},{name:'香菇',nums:'8朵	'},{name:'干黄酱',nums:'100克'},{name:'葱姜蒜',nums:'适量'},{name:'干辣椒',nums:'适量'},{name:'花椒',nums:'10克'},{name:'茴香籽',nums:'10克'},{name:'香叶',nums:'3片'},{	name:'八角和桂皮',nums:'各适量'},{name:'冰糖',nums:'10块'},{name:'生抽',nums:'2勺'},{name:'酱油',nums:'1勺'}],
				fuliao:[],
	...
	render(){
		...
		let _list=detals.filter(f=>f.code===code)[0];
		return (
